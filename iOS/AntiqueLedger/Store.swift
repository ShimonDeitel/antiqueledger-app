...
final class Store: ObservableObject {
    ...
    private let fileName = "antiqueledger_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Item One", detail: "First example entry.", date: now),
            Entry(title: "Sample Item Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Item Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
